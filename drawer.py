...
# the values of hue, saturation and value of the colors we want to identify
# colors = [[48, 90, 171, 179, 141, 255],  # roz
#             [0, 89, 180, 131, 149, 255],  # portocaliu
#             [75, 86, 103, 92, 159, 249],  # verde
#             [22, 35, 169, 89, 255, 255]]  # galben

colors = [[111, 117, 108, 179, 148, 255],  # roz
          [0, 116, 155, 12, 172, 255],  # portocaliu
          [75, 86, 103, 92, 159, 249],  # verde
          [27, 39, 0, 63, 104, 255]]  # galben
